            ...
            if (input.hasAttribute('required') || input.required) {
                if (!validateRequired(value)) {
                    const label = input.getAttribute('aria-label') || 
                                 ...
                                 name.replace(/[-_]/g, ' ');
                    showError(input, `${label.charAt(0).toUpperCase() + label.slice(1)} is required`);
                    isValid = false;
                }
            }
            
            if (isValid && (type === 'email' || name.toLowerCase().includes('email'))) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isFormValid) {
                ...
                if (submitBtn) {
                    ...
                    submitBtn.textContent = submitBtn.tagName === 'INPUT' ? 'Sending...' : 'Sending...';
                }
                ...
                successMsg.style.cssText = 'background: #c6f6d5; color: #276749; padding: 1rem; border-radius: 0.375rem; margin-top: 1rem; text-align: center;';
                ...
                if (submitBtn) {
                    ...
                    submitBtn.textContent = submitBtn.tagName === 'INPUT' ? originalText : originalText;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f77a4b71-ee64-4468-a25c-9b3a55c2f84c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f77a4b71-ee64-4468-a25c-9b3a55c2f84c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f77a4b71-ee64-4468-a25c-9b3a55c2f84c';
